...
*** Note since the excel files were too big to put in the repo, In the my_submissions folder are the snapshots for how it would look when the script is ran. Also the script is there and in [a link](https://github.com/slobanwala1/VBA-challenge/tree/master/Instructions/Resources)
